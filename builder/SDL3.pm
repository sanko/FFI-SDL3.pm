package builder::SDL3 {
    ...
    my %libversions = (                                                  # Allow custom lib versions
        SDL2       => $ENV{VSDL2}       // '2.26.4',
        SDL2_mixer => $ENV{VSDL2_mixer} // '2.6.3',
        SDL2_ttf   => $ENV{VSDL2_ttf}   // '2.20.2',
        SDL2_image => $ENV{VSDL2_image} // '2.6.3',
