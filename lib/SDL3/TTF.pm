package SDL3::TTF 0.01 {
    use strict;
    use SDL3::Utils;
    use experimental 'signatures';
    use base 'Exporter::Tiny';
    use SDL3::Utils qw[attach define load_lib];
    use SDL3;
    #
    our %EXPORT_TAGS;
    #
    ...
    #
    define ttf => [
        [ SDL_TTF_MAJOR_VERSION => sub () { SDL3::TTF::_ver()->major } ],
        [ SDL_TTF_MINOR_VERSION => sub () { SDL3::TTF::_ver()->minor } ],
        [ SDL_TTF_PATCHLEVEL    => sub () { SDL3::TTF::_ver()->patch } ],
        [   SDL_TTF_VERSION => sub ( $version = SDL3::Version->new() ) {
        ...
        [   SDL_TTF_COMPILEDVERSION => sub () {
                SDL3::SDL_VERSIONNUM( SDL_TTF_MAJOR_VERSION(), SDL_TTF_MINOR_VERSION(),
                    SDL_TTF_PATCHLEVEL() );
            }
        ],
    ...
    define ttf => [
        [ TTF_SetError => \&SDL3::SDL_SetError ], [ TTF_GetError => \&SDL3::SDL_GetError ],
        #
...
SDL3::TTF - TTF Image Loading Library
...
Returns a new L<SDL3::TTF::Font> structure on success.
...
=item C<src> - the source L<SDL3::RWops>
...
These functions deal with L<SDL3::TTF::Font> and global attributes.
...
These functions render text using a L<SDL3::TTF::Font>.
...
any returned surface.
    ...
    my $color = SDL3::Color->new({r => 0, g => 0, b => 0});
...
Returns a new L<SDL3::Surface> on success. C<undef> is returned on errors, such
...
(you!) is responsible for freeing any returned surface.
    ...
    # then free the text surface
    my $color   = SDL3::Color->new({r => 0, g => 0, b => 0});
    my $bgcolor = SDL3::Color->new({r => 0xff, g => 0xff, b => 0xff});
