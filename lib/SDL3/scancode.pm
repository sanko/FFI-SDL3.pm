...
SDL3::scancode - Defines Keyboard Scancodes

=head1 SYNOPSIS

    use SDL3 qw[:scancode];

=head1 DESCRIPTION

SDL3::scancode defines values of this type are used to represent keyboard keys,
among other places in the L<< scancode|SDL3::Keysym/C<scancode> >> field of the
L<SDL3::Event> structure.
