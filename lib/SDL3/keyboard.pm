package SDL3::keyboard 0.01 {
    ...
    attach keyboard => {
        ...
        SDL_GetKeyboardState => [                       # Make this nicer for returning lists
            ['int*'],
            'uint8[' . SDL3::SDL_NUM_SCANCODES() . ']' => sub ( $inner, $numkeys = () ) {
...
SDL3::keyboard - SDL Keyboard Event Handling

=head1 SYNOPSIS

    use SDL3 qw[:keyboard];
...
C<SDL_Scancode>|SDL3::scancode/C<SDL_Scancode> >> values.
...
C<SDL_Keymod>|SDL3::keycode/C<SDL_Keymod> >> for details.
...
C<SDL_Keymod>|SDL3::keycode/C<SDL_Keymod> >> values.
...
=item C<modstate> - the desired L<< C<SDL_Keymod>|SDL3::keycode/C<SDL_Keymod> >> for the keyboard
...
See L<< C<SDL_Keycode>|SDL3::keycode/C<SDL_Keycode> >> for details.

Expected parameters include:

=over

=item C<scancode> - the desired L<< C<SDL_Scancode>|SDL3::scancode/C<SDL_Scancode> >> to query

=back

Returns the L<< C<SDL_Keycode>|SDL3::keycode/C<SDL_Keycode> >> that corresponds
to the given L<< C<SDL_Scancode>|SDL3::scancode/C<SDL_Scancode> >>.
...
See L<< C<SDL_Scancode>|SDL3::scancode/C<SDL_Scancode> >> for details.

Expected parameters include:

=over

=item C<key> - the desired L<< C<SDL_Keycode>|SDL3::keycode/C<SDL_Keycode> >> to query

=back

Returns the L<< C<SDL_Scancode>|SDL3::scancode/C<SDL_Scancode> >> that
corresponds to the given L<< C<SDL_Keycode>|SDL3::keycode/C<SDL_Keycode> >>.
...
Returns the L<< C<SDL_Scancode>|SDL3::scancode/C<SDL_Scancode> >> , or
...
See L<< C<SDL_Scancode>|SDL3::scancode/C<SDL_Scancode> >> and L<<
C<SDL_Keycode>|SDL3::keycode/C<SDL_Keycode> >> for details.
...
=item C<rect> - the L<SDL3::Rect> structure representing the rectangle to receive text (ignored if C<undef>)
