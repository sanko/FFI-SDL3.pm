...
SDL3::sensor - SDL Sensor Event Handling
...
Returns an L<SDL3::Sensor> sensor object, or C<undef> if an error occurred.
...
Returns an L<SDL3::Sensor> object.
...
=item C<sensor> - the L<SDL3::Sensor> object
...
=item C<sensor> - the L<SDL3::Sensor> object to inspect
...
=item C<sensor> - the L<SDL3::Sensor> object to query
...
=item C<sensor> - the L<SDL3::Sensor> object to close
