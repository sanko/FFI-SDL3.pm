package SDL3::metal 0.01 {
    use SDL3::Utils;
    #
    use SDL3::video;

    package SDL3::MetalView {
        use SDL3::Utils;
        our $TYPE = has();
    };
    attach metal => {
...
SDL3::metal - Metal Laysers and Views on SDL Windows
...
=item C<window> - L<SDL3::Window> from which the drawable size should be queried
...
Destroy an existing L<SDL3::MetalView> object.
...
=item C<view> - L<SDL3::MetalView> to destroy
...
=item C<view> - L<SDL3::MetalView> to query
