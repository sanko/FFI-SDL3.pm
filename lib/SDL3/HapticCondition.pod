...
SDL3::HapticCondition - A structure containing a template for a Condition
effect
...
A SDL3::HapticCondition contains a template for a Condition effect.
...
L<SDL3::HapticDirection> diagram for which side is positive and which is
negative.
