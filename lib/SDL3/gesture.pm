...
SDL3::gesture - SDL Gesture Event Handling
...
SDL3::gesture provides functions that allow for simple and complex gesture
...
=item C<dst> - a L<SDL3::RWops> to save to
...
=item C<src> - a L<SDL3::RWops> to load from
