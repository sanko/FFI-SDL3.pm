package SDL3::error 0.01 {
    ...
    attach error => {
        ...
        SDL_GetError    => [ [] => 'string' ],
        SDL_GetErrorMsg => [
            [ 'string', 'int' ] => 'string' => sub {
                my ( $inner, $errstr, $maxlen ) = @_;
                $maxlen //= length $errstr;
...
SDL3::error - Simple Error Message Routines for SDL
...
C<<SDL_errorcode>|SDL3::Enum/C<:errorcode> >> enum.
