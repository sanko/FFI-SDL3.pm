...
SDL3::filesystem - Filesystem SDL API Functions

=head1 SYNOPSIS

    use SDL3 qw[:filesystem];

=head1 DESCRIPTION

SDL3::filesystem provides functions to deal with the filesystem.
