package SDL3::syswm 0.01 {
    ...
    package SDL3::SysWMmsg {
        use SDL3::Utils;    # TODO: Complex!
...
SDL3::syswm - SDL Custom System Window Manager Hooks
...
=item C<info> - an L<SDL3::SysWMinfo> structure filled in with window information
