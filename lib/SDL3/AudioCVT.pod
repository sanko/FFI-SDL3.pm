...
SDL3::AudioCVT - The Structure that Holds a Set of Audio Conversion Filters
...
SDL3::AudioCVT is a structure to hold a set of audio conversion filters and
buffers.

Note that various parts of the conversion pipeline can take advantage of SIMD
operations (like SSE2, for example). SDL3::AudioCVT doesn't require you to pass
