package SDL3::joystick 0.01 {
    ...
    package SDL3::Joystick {
        use SDL3::Utils;
        our $TYPE = has();
    };

    package SDL3::JoystickGUID {
        use SDL3::Utils;
...
SDL3::joystick - SDL Joystick Event Handling

=head1 SYNOPSIS

    use SDL3 qw[:joystick];
...
Get the L<SDL3::Joystick> associated with an instance id.
...
Returns an L<SDL3::Joystick> on success or C<undef> on failure; call
C<SDL_GetError( )> for more information.

=head2 C<SDL_JoystickFromPlayerIndex( ... )>

Get the L<SDL3::Joystick> associated with a player index.

Expected parameters include:

=over

=item C<player_index> - the player index to get the L<SDL3::Joystick> for
...
=item C<joystick> - the L<SDL3::Joystick> obtained from L<< C<SDL_JoystickOpen( ... )>|/C<SDL_JoystickOpen( ... )> >>
...
=item C<joystick> - the L<joystick|SDL3::Joystick> to query
...
=item C<joystick> - an L<SDL3::Joystick> structure containing joystick information
...
=item C<joystick> - the L<SDL3::Joystick> to query
