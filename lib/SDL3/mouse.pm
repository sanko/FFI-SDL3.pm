package SDL3::mouse 0.01 {
    ...
    define mouse => [
        ...
        [ SDL_BUTTON_X1     => 4 ],
        [ SDL_BUTTON_X2     => 5 ],
        [ SDL_BUTTON_LMASK  => sub () { SDL3::SDL_BUTTON( SDL3::SDL_BUTTON_LEFT() ) } ],
        [ SDL_BUTTON_MMASK  => sub () { SDL3::SDL_BUTTON( SDL3::SDL_BUTTON_MIDDLE() ) } ],
        [ SDL_BUTTON_RMASK  => sub () { SDL3::SDL_BUTTON( SDL3::SDL_BUTTON_RIGHT() ) } ],
        [ SDL_BUTTON_X1MASK => sub () { SDL3::SDL_BUTTON( SDL3::SDL_BUTTON_X1() ) } ],
        [ SDL_BUTTON_X2MASK => sub () { SDL3::SDL_BUTTON( SDL3::SDL_BUTTON_X2() ) } ]
    ];
...
SDL3::mouse - SDL Mouse Event Handling
...
L<SDL3::Surface>, you should use L<< C<SDL_CreateColorCursor( ...
...
=item C<surface> - an L<SDL3::Surface> structure representing the cursor image
