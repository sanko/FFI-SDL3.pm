package SDL3::messagebox 0.01 {
    ...
    package SDL3::MessageBoxButtonData {
        use SDL3::Utils;
        our $TYPE = has
            flags    => 'uint32',
            buttonid => 'int',
    ...
    package SDL3::MessageBoxColorScheme {
        use SDL3::Utils;
        our $TYPE = has colors => 'opaque'

            #'SDL_MessageBoxColor[' . SDL3::SDL_MESSAGEBOX_COLOR_MAX() . ']';
    };

    package SDL3::MessageBoxData {
        use SDL3::Utils;
        has
            flags       => 'uint32',
            window      => 'SDL_Window',
...
SDL3::messagebox - Modal Message Box Support
...
SDL3::messagebox provides functions to display modal message boxes.
...
=item C<messageboxdata> - the L<SDL3::MessageBoxData> structure with title, text and other options
...
L<SDL3::MessageBox> flags. If supported will display warning icon, etc.
...
Flags for L<SDL3::MessageBoxButtonData>.
