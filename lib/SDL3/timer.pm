package SDL3::timer 0.01 {
    use strict;
    use SDL3::Utils qw[attach define ffi load_lib threads_wrapped];
...
SDL3::timer - SDL Time Management Routines
...
SDL3::timer contains functions for dealing with time.
