package SDL3::pixels 0.01 {
    ...
    define pixels => [
        [ SDL_DEFINE_PIXELFOURCC => sub ( $A, $B, $C, $D ) { SDL3::SDL_FOURCC( $A, $B, $C, $D ) } ],
        ...
        [   SDL_BYTESPERPIXEL => sub ($X) {
                (
                    SDL3::SDL_ISPIXELFORMAT_FOURCC($X) ? (
                        (
                            ( ($X) == SDL3::SDL_PIXELFORMAT_YUY2() )     ||
                                ( ($X) == SDL3::SDL_PIXELFORMAT_UYVY() ) ||
                                ( ($X) == SDL3::SDL_PIXELFORMAT_YVYU() )
                        ) ? 2 : 1
                        ) :
                        ( ( ($X) >> 0 ) & 0xFF )
                )
        ...
        [   SDL_ISPIXELFORMAT_INDEXED => sub ($format) {
                (
                    !SDL3::SDL_ISPIXELFORMAT_FOURCC($format) &&
                        ( ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_INDEX1() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_INDEX4() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_INDEX8() ) )
                )
            }
        ],
        [   SDL_ISPIXELFORMAT_PACKED => sub ($format) {
                (
                    !SDL3::SDL_ISPIXELFORMAT_FOURCC($format) &&
                        ( ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_PACKED8() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_PACKED16() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_PACKED32() ) )
                )
            }
        ],
        [   SDL_ISPIXELFORMAT_ARRAY => sub ($format) {
                (
                    !SDL3::SDL_ISPIXELFORMAT_FOURCC($format) &&
                        ( ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_ARRAYU8() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_ARRAYU16() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_ARRAYU32() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_ARRAYF16() ) ||
                        ( SDL3::SDL_PIXELTYPE($format) == SDL3::SDL_PIXELTYPE_ARRAYF32() ) )
                )
            }
        ],
        [   SDL_ISPIXELFORMAT_ALPHA => sub ($format) {
                (
                    (
                        SDL3::SDL_ISPIXELFORMAT_PACKED($format) &&
                            ( ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_PACKEDORDER_ARGB() ) ||
                            ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_PACKEDORDER_RGBA() ) ||
                            ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_PACKEDORDER_ABGR() ) ||
                            ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_PACKEDORDER_BGRA() ) )
                    ) ||
                        (
                        SDL3::SDL_ISPIXELFORMAT_ARRAY($format) &&
                        ( ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_ARRAYORDER_ARGB() ) ||
                            ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_ARRAYORDER_RGBA() ) ||
                            ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_ARRAYORDER_ABGR() ) ||
                            ( SDL3::SDL_PIXELORDER($format) == SDL3::SDL_ARRAYORDER_BGRA() ) )
                        )
                )
            }
        ],
        ...
        [   SDL_ISPIXELFORMAT_FOURCC =>
                sub ($format) { ( ($format) && ( SDL3::SDL_PIXELFLAG($format) != 1 ) ) }
        ]
    ];
    enum SDL_PixelFormatEnum => [
        ...
        [   SDL_PIXELFORMAT_INDEX8 => sub () {
                SDL3::SDL_DEFINE_PIXELFORMAT( SDL3::SDL_PIXELTYPE_INDEX8(), 0, 0, 8, 1 );
            }
        ],
        ...
        [ SDL_PIXELFORMAT_BGR444 => sub () { SDL3::SDL_PIXELFORMAT_XBGR4444() } ],
        ...
        [ SDL_PIXELFORMAT_RGB555 => sub () { SDL3::SDL_PIXELFORMAT_XRGB1555() } ],
        ...
        [ SDL_PIXELFORMAT_BGR555 => sub () { SDL3::SDL_PIXELFORMAT_XBGR1555() } ],
        ...
        [ SDL_PIXELFORMAT_RGB888 => sub () { SDL3::SDL_PIXELFORMAT_XRGB8888() } ],
        ...
        [ SDL_PIXELFORMAT_BGR888 => sub () { SDL3::SDL_PIXELFORMAT_XBGR8888() } ],
        ...
        SDL3::SDL_BYTEORDER() == SDL3::SDL_BIG_ENDIAN() ? (
            [ SDL_PIXELFORMAT_RGBA32 => sub() { SDL3::SDL_PIXELFORMAT_RGBA8888() } ],
            [ SDL_PIXELFORMAT_ARGB32 => sub() { SDL3::SDL_PIXELFORMAT_ARGB8888() } ],
            [ SDL_PIXELFORMAT_BGRA32 => sub() { SDL3::SDL_PIXELFORMAT_BGRA8888() } ],
            [ SDL_PIXELFORMAT_ABGR32 => sub() { SDL3::SDL_PIXELFORMAT_ABGR8888() } ]
            ) : (
            [ SDL_PIXELFORMAT_RGBA32 => sub() { SDL3::SDL_PIXELFORMAT_ABGR8888() } ],
            [ SDL_PIXELFORMAT_ARGB32 => sub() { SDL3::SDL_PIXELFORMAT_BGRA8888() } ],
            [ SDL_PIXELFORMAT_BGRA32 => sub() { SDL3::SDL_PIXELFORMAT_ARGB8888() } ],
            [ SDL_PIXELFORMAT_ABGR32 => sub() { SDL3::SDL_PIXELFORMAT_RGBA8888() } ],
            ),
        [ SDL_PIXELFORMAT_YV12 => sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'Y', 'V', '1', '2' ) } ],
        [ SDL_PIXELFORMAT_IYUV => sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'I', 'Y', 'U', 'V' ) } ],
        [ SDL_PIXELFORMAT_YUY2 => sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'Y', 'U', 'Y', '2' ) } ],
        [ SDL_PIXELFORMAT_UYVY => sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'U', 'Y', 'V', 'Y' ) } ],
        [ SDL_PIXELFORMAT_YVYU => sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'Y', 'V', 'Y', 'U' ) } ],
        [ SDL_PIXELFORMAT_NV12 => sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'N', 'V', '1', '2' ) } ],
        [ SDL_PIXELFORMAT_NV21 => sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'N', 'V', '2', '1' ) } ],
        [   SDL_PIXELFORMAT_EXTERNAL_OES =>
                sub () { SDL3::SDL_DEFINE_PIXELFOURCC( 'O', 'E', 'S', ' ' ) }
        ]
    ];
...
SDL3::pixels - Enumerated Pixel Format Definitions
...
SDL3::pixels defines pixel format values and related functions.
...
Create an L<SDL3::PixelFormat> structure corresponding to a pixel format.
...
Returns the new L<SDL3::PixelFormat> structure or undef on failure; call
...
=item C<format> the C<SDL3::PixelFormat> structure to free
...
Returns a new L<SDL3::Palette> structure on success or undef on failure (e.g.
...
=item C<format> - the L<SDL3::PixelFormat> structure that will use the palette

=item C<palette> - the L<SDL3::Palette> structure that will be used
...
=item C<palette> - the L<SDL3::Palette> structure to be freed
...
=item C<format> - an L<SDL3::PixelFormat> structure describing the pixel format
...
=item C<format> - an L<SDL3::PixelFormat> structure describing the format of the pixel
