package SDL3 0.09 {
    ...
    #
    require SDL3::stdinc;
    require SDL3::assert;                          # Enable with use var like C<use SDL3 -assert=3;>
    require SDL3::atomic;
    require SDL3::rwops;                           # Does not belong here?
    require SDL3::audio;
    require SDL3::clipboard;
    require SDL3::cpuinfo;
    require SDL3::error;
    require SDL3::events;
    require SDL3::filesystem;
    require SDL3::gamecontroller;
    require SDL3::haptic;
    require SDL3::hints;
    require SDL3::joystick;
    require SDL3::loadso;
    require SDL3::log;
    require SDL3::messagebox;
    require SDL3::metal;
    require SDL3::mutex;
    require SDL3::power;
    require SDL3::render;
    ...
    require SDL3::misc;
    #
    require SDL3::platform;    # We bypass config.h to get platform.h
    require SDL3::syswm;
    #
    #
    define init => [
    ...
    package SDL3::Mixer::Mix::MusicType {
        use SDL3::Utils;
        has;
    };

    package SDL3::Mixer::Fading {
        use SDL3::Utils;
        has;
    };
    ...
    package SDL3::RTF::Context {
        use SDL3::Utils;
        has;
    };

    package SDL3::RTF::FontEngine {
        use SDL3::Utils;
        has;
    };
...
SDL3 is a L<FFI::Platypus> backed bindings to the B<S>imple B<D>irectMedia
...
=item C<flags> which may be any be imported with the L<< C<:init>|SDL3::Enum/C<:init> >> tag and may be OR'd together
